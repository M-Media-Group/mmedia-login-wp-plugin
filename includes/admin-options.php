...
//         add_options_page( 'Log in with M Media', 'Log in with M Media', 'manage_options', 'wposso_settings', array(
    ...
    public function options_do_notifications_page()
    {
        ...
        <div class="wrap">
		    ...
		    <?php }}echo $this->m_media_user->user->name ?? "<div class='card'>You are not currently logged in via M Media. Log in with M Media to get access to your notifications.</div>";?>
	 	</div>
		<?php
}
